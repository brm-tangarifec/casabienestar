...
<!--Acá se pone el contenido-->
 ...
 foreach ($var["system_main"]["nodes"] as $key) {
 	/*echo '<pre>';
 	print_r($key["body"]["#object"]);
 	echo '</pre>';*/
 	print'<article class="col-lg-4 col-md-4 col-sm-4 col-xs-12 module-box module-box-receta">';
 	print '<figure class="img-wrapper">';
 	print '<a href="/fbappCasaBienestar/'.$key["body"]["#object"]->field_receta_url['und'][0]['value'].'">';
    print  '<img src="'.file_create_url($key["body"]["#object"]->field_receta_imgpq['und'][0]['uri']).'" alt="'.$key["body"]["#object"]->field_receta_imgpq['und'][0]['alt'].'" title="'.$key["body"]["#object"]->field_receta_imgpq['und'][0]['title'].'" class="img-article img-responsive">';
    print '</a>';
    print '</figure>';
    print '<h3> <a href="/fbappCasaBienestar/'.$key["body"]["#object"]->field_receta_url['und'][0]['value'].'">'.$key["body"]["#object"]->title.'</a></h3>';
 	print '</article>';
 	//var_dump($key["body"]["#object"]->title);
 }
 //var_dump($var["system_main"]["nodes"]);
 ?>
