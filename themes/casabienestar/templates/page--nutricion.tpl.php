    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
          <!--Logo-->
          <h2><a href="/fbappCasaBienestar/"><img src="<?php print base_path() . path_to_theme(); ?>/images/logo-nestle-blanco.svg" alt="NESTLÉ&amp;reg; A gusto con la vida" class="img-responsive"></a></h2>
          <!--/-Logo-->
        </div>
...
<!--Imagen y nombre de Sección-->
  <section>
    <div class="container-fluid u-no-border seccion-nestle">
      <div class="row max-width">
        <div class="col-lg-12 color-nutricion">
          <div class="btn btn-nutricion btn-fab btn-raised icon icon-nutricion"></div>
          <h1 class="seccion-nombre">Nutrición</h1>
          <div class="img-seccion"></div>
        </div>
      </div>
    </div>
  </section>
...
<section>
    ...
    <div class="container-fluid">
      <!--Principales / Recientes-->
      <div class="row">



          <?php print render($page['destacado']);?>
      ...
      <!--Articulos antiguos-->
      <div class="row">
         <?php print render($page['articulosv']);?>
      <!--/-Articulos antiguos-->
    </div>
    <!--/-Articulos de la sección-->
  </div>
